...
-- changeset aaaa:1722247567315-1
CREATE TABLE "order"
(
...
-- changeset aaaa:1722247567315-2
...
(
    ...
    order_id      BIGINT,
    CONSTRAINT "order_detailPK" PRIMARY KEY (id)
);

-- changeset aaaa:1722247567315-3
